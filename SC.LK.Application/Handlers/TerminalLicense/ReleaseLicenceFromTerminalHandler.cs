...
public class ReleaseLicenceFromTerminalHandler : IRequestHandler<ReleaseLicenceFromTerminalRequest, ReleaseLicenceFromTerminalResponse>
{
    ...
    public ReleaseLicenceFromTerminalHandler(
    ...
    /// <returns></returns>
    public async Task<ReleaseLicenceFromTerminalResponse> Handle(ReleaseLicenceFromTerminalRequest request,
        CancellationToken cancellationToken)
    {
        ...
        var res = await _repositoryConfigurationService.ReleaseLicenceFromTerminalAsync(LicenceTerminal);

        if (res)
            return new ReleaseLicenceFromTerminalResponse() {Success = true};
        else
            return new ReleaseLicenceFromTerminalResponse() {Success = false, ErrorMessage = "Error"};
