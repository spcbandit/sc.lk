...
internal class Operation_Get_Tester
{
    [Test]
    async public Task GetOperations_resultOK()
    {
        //arrange
        ...
        //act 
        var responce = await client.GetAsync(client.BaseAddress + "finance/getOperations");
