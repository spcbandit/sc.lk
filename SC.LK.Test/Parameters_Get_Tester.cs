...
{
    internal class Parameters_Get_Tester
    {
        [Test]
        async public Task GetParametersByParametersId_resultOK()
        {
            //arrange
            ...
            var parametersId = "?parametersId=3fa85f64-5717-4562-b3fc-2c963f66afa6";
            //act 
            var responce = await client.GetAsync(client.BaseAddress + "parameters/GetParametersByParametersId" + parametersId);
