...
internal class FullConfig_Get_Tester
{
    [Test]
    async public Task GetFullConfig_resultOK()
    {
        //arrange
        ...
        //act 
        var responce = await client.GetAsync(client.BaseAddress + "instructions/getFullInstructions");
