...
{
    internal class Configurations_Get_Tester
    {
        [Test]
        async public Task GetAllConfigurations_resultOK()
        {
            ...
            //act 
            var responce = await client.GetAsync(client.BaseAddress + "configurations/getAllConfigurations" + ContractorId);
        ...
        [Test]
        async public Task GetAllDivisionsTerminals_resultOK()
        {
            //arrange
            var webAppFactory = new WebApplicationFactory<Program>();
            var client = webAppFactory.CreateClient();
            ...
            var ContractorId = "?ContractorId=08da6ee6-00a6-4da4-8c9a-d050b3127e14";
            //act 
            var responce = await client.GetAsync(client.BaseAddress + "configurations/getAllDivisionsTerminals" + ContractorId);
            //Console.WriteLine(responce.Content.ReadAsStringAsync().Result);
            //assert
            Assert.AreEqual("OK", responce.StatusCode.ToString());
        }
