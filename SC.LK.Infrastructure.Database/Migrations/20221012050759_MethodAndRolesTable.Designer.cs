...
namespace SC.LK.Infrastructure.Database.Migrations
{
    ...
    [Migration("20221012050759_MethodAndRolesTable")]
    partial class MethodAndRolesTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AvailableRolesEntityMethodAccessTypeEntity", b =>
                {
                    b.Property<Guid>("AccessTypesId")
                        .HasColumnType("char(36)");

                    b.Property<Guid>("MethodAccessTypeEntitiesId")
                        .HasColumnType("char(36)");

                    b.HasKey("AccessTypesId", "MethodAccessTypeEntitiesId");

                    b.HasIndex("MethodAccessTypeEntitiesId");

                    b.ToTable("AvailableRolesEntityMethodAccessTypeEntity");
                });
            ...
            modelBuilder.Entity("SC.LK.Application.Domains.Entities.AvailableRolesEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<decimal>("PermissionType")
                    ...
                    b.ToTable("AvailableRolesEntities");
                });
            ...
            modelBuilder.Entity("SC.LK.Application.Domains.Entities.MethodAccessTypeEntity", b =>
                {
                    ...
                    b.ToTable("MethodAccessTypeEntities");
                });
            ...
            modelBuilder.Entity("SC.LK.Application.Domains.Entities.TicketEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");

                    b.Property<Guid>("FromContragent")
                        .HasColumnType("char(36)");
                    ...
                    b.Property<int>("TicketStatusType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SC.LK.Application.Domains.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<Guid>("AvailableRoles")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AvailableRolesEntityMethodAccessTypeEntity", b =>
                {
                    b.HasOne("SC.LK.Application.Domains.Entities.AvailableRolesEntity", null)
                        .WithMany()
                        .HasForeignKey("AccessTypesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SC.LK.Application.Domains.Entities.MethodAccessTypeEntity", null)
                        .WithMany()
                        .HasForeignKey("MethodAccessTypeEntitiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
